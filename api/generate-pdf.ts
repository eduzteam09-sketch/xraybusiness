  ...
  const insights = [
    {
      ...
      text:
        ...
        "Nguồn thu ổn định từ khách hàng hài lòng, sản phẩm cốt lõi có chất lượng vững chắc.").trim(),
      bg: [240, 253, 244],
      border: [187, 247, 208],
    ...
    },
    {
      ...
      text:
        ...
        "Quy trình bán hàng phụ thuộc nhiều vào nhân sự, thiếu hệ thống tự động ghi nhận và nhắc nhở mua lại.").trim(),
      bg: [254, 242, 242],
      border: [254, 202, 202],
    ...
    },
    {
      ...
      text:
        ...
        "Ứng dụng tự động hóa & AI vào kênh chăm sóc khách hàng và bán thêm combo dịch vụ giúp tối ưu lợi nhuận.").trim(),
      bg: [239, 246, 255],
      border: [191, 219, 254],
